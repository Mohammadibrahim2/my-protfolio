...
return(
    <div className="bg-gray-200">
        <div className="h-[300px] w-full grid lg:grid-cols-3 grid-cols-2 gap-4 bg-gray-200 drop-shadow-lg">
  ...
  <div className="card-body">
    ...
    <button className="px-4 py-3 text-blue-700" ><a href={projectData.git}>Github</a></button>
   <button className="px-4 py-3 text-blue-700"><a href={projectData.livesite}>Live site</a></button>
   <button className="px-4 py-3 text-blue-700"><a href="https://github.com/Mohammadibrahim2/protfolio-server">Server site github</a></button>
    </div>
  </div>
</div>
